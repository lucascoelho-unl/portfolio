...
export default function ImageCarousel() {
  ...
  const handleDragEnd = (e: any, { offset, velocity }: PanInfo) => {
    ...
    // User requested: "right goes to the next, left previous"
    // So swiping right (offset.x > 0) goes Next.
  ...
  return (
    <div className="flex items-center justify-center gap-12 sm:gap-24 md:gap-32 w-full max-w-5xl mx-auto py-8 overflow-hidden">
      ...
      <div className="relative w-full max-w-[20rem] h-[500px]">
            ...
            <motion.div
              ...
              variants={{
                visible: (d) => {
                  ...
                  return {
                    x: direction * (90 + (absD - 1) * 50),
                    y: 0,
                    scale: 1 - absD * 0.12,
                    opacity: 1,
                    zIndex: 20 - absD,
                    rotate: direction * 5 * absD,
